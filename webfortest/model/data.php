...
class baseObj {
    ...
    {
        $this->mysql = new mysqli("localhost", "developer", "123456", "propertytest");
...
class propertyData extends baseObj {
    ...
    public function getLivingroom ($ID) { $livingroom = $this->get( $ID, 'Livingroom') ; return $livingroom;}
    public function getDiningroom ($ID) { $diningroom = $this->get( $ID, 'Diningroom') ; return $diningroom;}
}

class hdbData extends baseObj {
    public function __construct(){
        parent::__construct();
        $this->table = 'HDB';
    }
...
class condoData extends baseObj {
    public function __construct(){
        parent::__construct();
        $this->table = 'Condo';
    }
